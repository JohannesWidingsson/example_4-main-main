...
class Location_Key extends StatelessWidget {
  @override
                              ...
                              child: Column(
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: Text(
                                      'Du kan ange plats genom din nuvarande\nposition eller genom att skapa en\nmarkering på kartan som genererar dina koordinater',
                                      style: TextStyle(
                                        fontSize: 14.0,
                                        fontFamily: 'Roboto',
